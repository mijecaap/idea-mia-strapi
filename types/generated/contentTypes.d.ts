...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    read_time: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<5>;
...
export interface ApiCustomizationSchemaCustomizationSchema
  extends Struct.CollectionTypeSchema {
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    about_section_content: Schema.Attribute.RichText;
    about_section_image: Schema.Attribute.Media<'images'>;
    about_section_title: Schema.Attribute.String;
    banner_images: Schema.Attribute.Media<'images', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featured_categories_title: Schema.Attribute.String;
    featured_products_title: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    new_products_title: Schema.Attribute.String;
    on_sale_title: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customer_document: Schema.Attribute.String;
    customer_document_type: Schema.Attribute.Enumeration<
      ['dni', 'ce', 'ruc', 'passport']
    > &
      Schema.Attribute.DefaultTo<'dni'>;
    customer_email: Schema.Attribute.Email & Schema.Attribute.Required;
    customer_first_name: Schema.Attribute.String & Schema.Attribute.Required;
    customer_last_name: Schema.Attribute.String & Schema.Attribute.Required;
    customer_phone: Schema.Attribute.String & Schema.Attribute.Required;
    items: Schema.Attribute.JSON & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    needs_shipping: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    notes: Schema.Attribute.Text;
    order_id: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    payment_method: Schema.Attribute.Enumeration<
      ['yape', 'plin', 'transfer', 'cash']
    > &
      Schema.Attribute.DefaultTo<'yape'>;
    payment_proof: Schema.Attribute.Media<'images'>;
    payment_proof_filename: Schema.Attribute.String;
    payment_proof_uploaded: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
    shipping_address: Schema.Attribute.Text;
    shipping_cost: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    shipping_department: Schema.Attribute.String;
    shipping_district: Schema.Attribute.String;
    shipping_province: Schema.Attribute.String;
    shipping_reference: Schema.Attribute.Text;
...
export interface ApiProductImageProductImage
  ...
  info: {
    description: 'Images for products with sorting and type classification';
  ...
  attributes: {
    ...
    image_type: Schema.Attribute.Enumeration<
      ['main', 'gallery', 'lifestyle', 'variant']
    > &
    ...
    publishedAt: Schema.Attribute.DateTime;
    show_in_gallery: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    show_in_listing: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    sort_order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiProductVariantProductVariant
  ...
  info: {
    description: 'Product variants for different options like size, color, etc.';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variant_type: Schema.Attribute.String & Schema.Attribute.Required;
    variant_value: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    custom_instructions: Schema.Attribute.Text;
    customizable: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    customization_schemas: Schema.Attribute.Relation<
      'manyToMany',
      'api::customization-schema.customization-schema'
    >;
    ...
    is_on_sale: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    ...
    max_custom_text_length: Schema.Attribute.Integer;
    meta_description: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 160;
      }>;
    ...
    price: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    production_time: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    short_description: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::customization-schema.customization-schema': ApiCustomizationSchemaCustomizationSchema;
